...
class widgets extends Component {
  ...
  componentDidMount() {
    this.apiCall(
      "http://localhost:3002/cards/arte/apiArte",
      this.actualizarDatoUltimoArte
    );
    this.apiCall(
      "http://localhost:3002/apiUsuario",
      this.actualizarDatoUltimoUsuario
    );
  }
              ...
              <div className="row">
                <div className="col-lg-12 mb-4">
                  <div className="card bg-info text-white shadow">
                    <div className="card-body">
                      Correo electronico: {this.state.ultimoUsuario.correo}
                    </div>
                  </div>
                </div>
                <div className="col-lg-12 mb-4">
                  <div className="card bg-info text-white shadow">
                    <div className="card-body">
                      Fecha de nacimiento: {this.state.ultimoUsuario.nacimiento}
                    </div>
                  </div>
                </div>
                <div className="col-lg-12 mb-4">
                  <div className="card bg-info text-white shadow">
                    <div className="card-body">
                      Telefono: {this.state.ultimoUsuario.telefono}
                    </div>
                  </div>
                </div>
              </div>
